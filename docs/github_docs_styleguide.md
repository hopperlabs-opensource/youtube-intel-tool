...
- `github_docs_styleguide.md` (short pointer to canonical docs copy)

### 1.2 Canonical docs under `/docs`
- `docs/github_docs_styleguide.md` (this file, canonical source)
...
```text
Follow docs/github_docs_styleguide.md.
